...
uint8_t EEPROM ee_config[][4] = {
    ...
    /* 1d */ {397 - 340, 397 - 340, 16, 255}, //!< value for 25C => 397
                                              //!< temperature calibration table
    /* 1e */ {472 - 397, 472 - 397, 16, 255}, //!< value for 20C => 472
                                              //!< temperature calibration table
    /* 1f */ {549 - 472, 549 - 472, 16, 255}, //!< value for 15C => 549
                                              //!< temperature calibration table
    /* 20 */ {614 - 549, 614 - 549, 16, 255}, //!< value for 10C => 614
                                              //!< temperature calibration table
    /* 21 */ {675 - 614, 675 - 614, 16, 255}, //!< value for 05C => 675
                                              //!< temperature calibration table

    /* 22 */ {0, 0, 0, ((TEMP_MAX + 1) << 1) + 1}, //!< bit0: timer_mode; =0
                                                   //!< only one program, =1
                                                   //!< programs for weekdays
//                                                                                                                     >1 manual mode, the higher bits contain the saved temperature << 1
#if HR25
    /*    */ {125, 125, 80, 160}, //!< bat_half_thld; treshold for half battery
                                  //!< indicator [unit 0.02V]=[unit 0.01V per
                                  //!< cell]
#endif
    /*    */ {120, 120, 80, 160}, //!< bat_warning_thld; treshold for battery
                                  //!< warning [unit 0.02V]=[unit 0.01V per
                                  //!< cell]
    /*    */ {100, 100, 80, 160}, //!< bat_low_thld; treshold for battery low
                                  //!< [unit 0.02V]=[unit 0.01V per cell]
    /*    */ {1, 1, 0, 1},        //!< allow_ADC_during_motor
#if HW_WINDOW_DETECTION
    /*    */ {1, 1, 0, 1},   //!< window_open_detection_enable
    /*    */ {5, 5, 0, 240}, //!< window_open_detection_delay [sec] max 4
                             //!< minutes
    ...
    /*    */ {5, 0, 0, 255},  //!< temp_boost_tempchange_heat,0,1°C,
                              //!< boosttime=error/10(0,1°C)*time/tempchange
    /*    */ {64, 0, 0, 255}, //!< temp_boost_time_cool, minutes
    /*    */ {15, 0, 0, 255}, //!< temp_boost_time_heat, minutes
#endif
#if TEMP_COMPENSATE_OPTION
    /*    */ {0, 0, 0, 255}, //!< offset to roomtemp 1=0,1°C, binary complement
                             //!< for <0
#endif
};
