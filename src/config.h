...
/*!
 * \file       config.h
 * \brief      This headerfile only contains information about the configuration
 * of the HR20E and its functionality \author     Juergen Sachs
 * (juergen-sachs-at-gmx-dot-de) Jiri Dobry <jdobry-at-centrum-dot-cz> \date
 * $Date$ $Rev$
 */

/*
 * In this file we define only configuration parameters, for example what kind
 * of control port we have.
 */
