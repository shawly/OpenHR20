...
/*!
 *  \note dirty trick with shared array for \ref COM_hex_parse and \ref
 * COM_commad_parse code size optimalization
 */
 ...
 *
 *	\note hex numbers use ONLY lowcase chars, upcase is reserved for
 *commands
 *
 ******************************************************************************/
 ...
 *termination char \note hex numbers use ONLY lowcase chars, upcase is reserved
 *for commands \note   V\n - print version information \note   D\n - print
 *status line \note   Taa\n - print watched variable aa (return 2 or 4 hex
 *numbers) see to \ref watch.c \note   Gaa\n - get configuration byte with hex
 *address aa see to \ref eeprom.h 0xff address returns EEPROM layout version
 *  \note   Saadd\n - set configuration byte aa to value dd (hex)
 *  \note   Rab\n - get timer for day a slot b, return cddd=(timermode c time
 *ddd) (hex) \note   Wabcddd\n - set timer  for day a slot b timermode c time
 ...
 *  \note   Mxx\n - set mode and close window (00=manu 01=auto fd=nochange/close
 *window only) \note	Lxx\n - Lock keys, and return lock status (00=unlock,
